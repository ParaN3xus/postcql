...
#   timestamp: 2026-04-10T14:33:32+00:00
...
class Address(BaseModel):
    ...
    parentIndex: conint(ge=-1) | None = Field(
...
class Message1(BaseModel):
    ...
    markdown: str | None = Field(None, description='A Markdown message string.')
    id: str | None = Field(None, description='The identifier for this message.')
...
class Message2(BaseModel):
    ...
    text: str | None = Field(None, description='A plain text message string.')
    markdown: str | None = Field(None, description='A Markdown message string.')
...
class ReportingDescriptorReference1(BaseModel):
    ...
    toolComponent: ToolComponentReference | None = Field(
        None,
...
class Edge(BaseModel):
    ...
    label: Message | None = Field(None, description='A short description of the edge.')
...
class EdgeTraversal(BaseModel):
    ...
    finalState: dict[str, MultiformatMessageString] | None = Field(
        None,
        description='The values of relevant expressions after the edge has been traversed.',
    )
    stepOverEdgeCount: conint(ge=0) | None = Field(
        None,
...
class ExternalPropertyFileReference1(BaseModel):
    ...
    itemCount: conint(ge=-1) | None = Field(
        -1,
...
class ExternalPropertyFileReferences(BaseModel):
    ...
    externalizedProperties: ExternalPropertyFileReference | None = Field(
        None,
    ...
    logicalLocations: list[ExternalPropertyFileReference] | None = Field(
        [],
    ...
    threadFlowLocations: list[ExternalPropertyFileReference] | None = Field(
        [],
    ...
    webRequests: list[ExternalPropertyFileReference] | None = Field(
        [],
        description='An array of external property files containing run.requests arrays to be merged with the root log file.',
        min_length=0,
        validate_default=True,
    )
    webResponses: list[ExternalPropertyFileReference] | None = Field(
        [],
...
class GraphTraversal1(BaseModel):
    ...
    resultGraphIndex: conint(ge=-1) | None = Field(
        -1,
    ...
    edgeTraversals: list[EdgeTraversal] | None = Field(
        [],
...
class GraphTraversal2(BaseModel):
    ...
    runGraphIndex: conint(ge=-1) | None = Field(
        -1,
        description='The index within the run.graphs to be associated with the result.',
    )
...
class Replacement(BaseModel):
    ...
    insertedContent: ArtifactContent | None = Field(
        None,
...
class ReportingDescriptor(BaseModel):
    ...
    deprecatedIds: list[str] | None = Field(
        None,
    ...
    deprecatedGuids: list[DeprecatedGuid] | None = Field(
        None,
    ...
    deprecatedNames: list[str] | None = Field(
        None,
    ...
    messageStrings: dict[str, MultiformatMessageString] | None = Field(
        None,
    ...
    defaultConfiguration: ReportingConfiguration | None = Field(
        None, description='Default reporting configuration information.'
    )
    helpUri: AnyUrl | None = Field(
        None,
...
class SpecialLocations(BaseModel):
    ...
    displayBase: ArtifactLocation | None = Field(
        None,
...
class ToolComponent(BaseModel):
    ...
    semanticVersion: str | None = Field(
        None,
        description='The tool component version in the format specified by Semantic Versioning 2.0.',
    )
    dottedQuadFileVersion: constr(pattern=r'[0-9]+(\.[0-9]+){3}') | None = Field(
        None,
    ...
    globalMessageStrings: dict[str, MultiformatMessageString] | None = Field(
        None,
    ...
    isComprehensive: bool | None = Field(
        False,
    ...
    localizedDataSemanticVersion: str | None = Field(
        None,
    ...
    minimumRequiredLocalizedDataSemanticVersion: str | None = Field(
        None,
    ...
    associatedComponent: ToolComponentReference | None = Field(
        None,
    ...
    translationMetadata: TranslationMetadata | None = Field(
        None,
        description='Translation metadata, required for a translation, not populated by other component types.',
    )
    supportedTaxonomies: list[ToolComponentReference] | None = Field(
        [],
...
class VersionControlDetails(BaseModel):
    ...
    revisionTag: str | None = Field(
        None, description='A tag that has been applied to the revision.'
    )
    asOfTimeUtc: AwareDatetime | None = Field(
        None,
    ...
    mappedTo: ArtifactLocation | None = Field(
        None,
...
class WebRequest(BaseModel):
    ...
    target: str | None = Field(None, description='The target of the request.')
    method: str | None = Field(
        None,
        description="The HTTP method. Well-known values are 'GET', 'PUT', 'POST', 'DELETE', 'PATCH', 'HEAD', 'OPTIONS', 'TRACE', 'CONNECT'.",
    )
    headers: dict[str, str] | None = Field(None, description='The request headers.')
    parameters: dict[str, str] | None = Field(
        None, description='The request parameters.'
    )
    body: ArtifactContent | None = Field(None, description='The body of the request.')
    properties: PropertyBag | None = Field(
        None,
...
class WebResponse(BaseModel):
    ...
    reasonPhrase: str | None = Field(
        None, description="The response reason. Example: 'Not found'."
    )
    headers: dict[str, str] | None = Field(None, description='The response headers.')
    body: ArtifactContent | None = Field(None, description='The body of the response.')
    noResponseReceived: bool | None = Field(
...
class Artifact(BaseModel):
    ...
    mimeType: constr(pattern=r'[^/]+/.+') | None = Field(
    ...
    lastModifiedTimeUtc: AwareDatetime | None = Field(
        None,
...
class PhysicalLocation1(BaseModel):
    ...
    artifactLocation: ArtifactLocation | None = Field(
        None, description='The location of the artifact.'
    )
...
class PhysicalLocation2(BaseModel):
    ...
    address: Address | None = Field(None, description='The address of the location.')
    artifactLocation: ArtifactLocation = Field(
...
class ResultProvenance(BaseModel):
    ...
    firstDetectionTimeUtc: AwareDatetime | None = Field(
        None,
    ...
    lastDetectionTimeUtc: AwareDatetime | None = Field(
        None,
    ...
    invocationIndex: conint(ge=-1) | None = Field(
        -1,
    ...
    conversionSources: list[PhysicalLocation] | None = Field(
        [],
...
class Location(BaseModel):
    ...
    physicalLocation: PhysicalLocation | None = Field(
        None, description='Identifies the artifact and region.'
    )
    logicalLocations: list[LogicalLocation] | None = Field(
        [],
...
class Node(BaseModel):
    ...
    label: Message | None = Field(None, description='A short description of the node.')
    location: Location | None = Field(
        None, description='A code location associated with the node.'
    )
    children: list[Node] | None = Field(
        [], description='Array of child nodes.', validate_default=True
    )
    properties: PropertyBag | None = Field(
        None,
...
class Graph(BaseModel):
    ...
    description: Message | None = Field(None, description='A description of the graph.')
...
class ThreadFlowLocation(BaseModel):
    ...
    location: Location | None = Field(None, description='The code location.')
...
class SarifException(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    kind: str | None = Field(
    ...
    innerExceptions: list[SarifException] | None = Field(
        [],
...
class Notification(BaseModel):
    ...
    associatedRule: ReportingDescriptorReference | None = Field(
        None,
...
class Invocation(BaseModel):
    ...
    endTimeUtc: AwareDatetime | None = Field(
        None,
    ...
    stdoutStderr: ArtifactLocation | None = Field(
        None,
...
class Result(BaseModel):
    ...
    ruleIndex: conint(ge=-1) | None = Field(
        -1,
    ...
    analysisTarget: ArtifactLocation | None = Field(
        None,
    ...
    graphTraversals: list[GraphTraversal] | None = Field(
        [],
        description="An array of one or more unique 'graphTraversal' objects.",
        min_length=0,
        validate_default=True,
    )
    relatedLocations: list[Location] | None = Field(
        [],
    ...
    baselineState: BaselineState | None = Field(
        None,
    ...
    hostedViewerUri: AnyUrl | None = Field(
        None, description='An absolute URI at which the result can be viewed.'
    )
    workItemUris: list[AnyUrl] | None = Field(
...
class Conversion(BaseModel):
    ...
    analysisToolLogFiles: list[ArtifactLocation] | None = Field(
        [],
...
class ExternalProperties(BaseModel):
    ...
    externalizedProperties: PropertyBag | None = Field(
        None,
    ...
    threadFlowLocations: list[ThreadFlowLocation] | None = Field(
        [],
    ...
    webRequests: list[WebRequest] | None = Field(
        [],
        description='Requests that will be merged with a separate run.',
        min_length=0,
        validate_default=True,
    )
    webResponses: list[WebResponse] | None = Field(
        [],
...
class Run(BaseModel):
    ...
    versionControlProvenance: list[VersionControlDetails] | None = Field(
        [],
        description='Specifies the revision in version control of the artifacts that were scanned.',
        min_length=0,
        validate_default=True,
    )
    originalUriBaseIds: dict[str, ArtifactLocation] | None = Field(
        None,
    ...
    automationDetails: RunAutomationDetails | None = Field(
        None, description='Automation details that describe this run.'
    )
    runAggregates: list[RunAutomationDetails] | None = Field(
        [],
    ...
    newlineSequences: list[str] | None = Field(
        ['\r\n', '\n'],
    ...
    columnKind: ColumnKind | None = Field(
        None, description='Specifies the unit in which the tool measures columns.'
    )
    externalPropertyFileReferences: ExternalPropertyFileReferences | None = Field(
        None,
    ...
    specialLocations: SpecialLocations | None = Field(
        None,
...
class SarifLog(BaseModel):
    ...
    inlineExternalProperties: list[ExternalProperties] | None = Field(
        None,
...
Node.model_rebuild()
SarifException.model_rebuild()
SarifLog.model_rebuild(_types_namespace=globals(), force=True)
